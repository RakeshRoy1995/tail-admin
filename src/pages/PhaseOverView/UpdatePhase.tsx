...
export default function UpdatePhase({ data, handleSubmit }: any) {
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex-fill bg-white border rounded shadow-sm">
        ...
        <div className="p-4">
          <h6 className="mb-4">Update Phase:</h6>
          ...
          <div className="row mb-4 align-items-center">
            ...
            <div className="col-sm-9">
              <div className="input-group">
                ...
                <textarea className="form-control bg-light" name="discription" cols={5} rows={5}>
                  {data?.discription}
                </textarea>
              </div>
            </div>
